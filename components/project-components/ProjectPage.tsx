...
import { CaseStudiesSimilar,CaseStudyGallery, CaseStudySummary } from "components/sections/projects";
        ...
        <Page title={project.title}>
          ...
          >
            ...
            <Grid item xs={12} md={8}>
                <Typography variant="h3" component="h2" sx={{mb:2}}> Project Brief</Typography>
                    <Typography>{project.brief}</Typography>
                    <Typography variant="h3" component="h2" sx={{ mt: 2, mb: 2 }}> Project Scope</Typography>
                    <PostBody content={project.scope} />
                    <Typography variant="h3" component="h2" sx={{ mt: 2, mb: 2 }}> Results</Typography>
